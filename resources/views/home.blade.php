                ...
                <div class="text">
                    ...
                    <div class="why-points row text-center mt-4 gx-5">
                        <div class="col-md-6 mb-4 px-3">
                            ...
                            <p>Didatangkan langsung dari Singapura dan Australia</p>
                        </div>
                        <div class="col-md-6 mb-4 px-3">
                        ...
                        <div class="col-md-6 mb-4 px-3">
                            ...
                            <p>Eks PT. Astragraphia, profesional dan handal</p>
                        </div>
                        <div class="col-md-6 mb-4 px-3">
                            <i class="fas fa-building fa-2x text-danger mb-2"></i>
                            <h5>Cocok untuk Perkantoran</h5>
                            <p>Efisien, praktis dan sesuai kebutuhan bisnis modern</p>
                        </div>
                    </div>
        ...
        <div class="container px-md-5 px-3">
            <div class="content">
                <div class="text">
                    ...
                    <p class="text-center">
                        Sewa satu mesin fotocopy dari Fujigraphic, dan Anda tidak perlu lagi membeli printer, scanner, atau fax.</p> 
                        <p class="text-center  mb-5">
                            Semua unit sudah terhubung ke Wi-Fi, siap digunakan sebagai printer dan scanner langsung dari komputer atau laptop Anda.
                    </p>
                        <div class="why-points row text-center mt-4 gx-5">
                            ...
                            <div class="col-md-4 mb-4 px-3">
                                ...
                                <p><strong>Suku Cadang Asli</strong><br>Consumables Fuji Xerox asli dan berkualitas.</p>
                            </div>
                            <div class="col-md-4 mb-4 px-3">
                                <img src="{{ asset('images/icons/3.png') }}" alt="Layanan Cepat" class="why-icon mb-2">
                                <p><strong>Layanan Cepat</strong></br>Respon maksimal </br>1 hari dari teknisi profesional.</p>
                            </div>
                            <div class="col-md-4 mb-4 px-3">
                            ...
                            <div class="col-md-4 mb-4 px-3">
                                ...
                                <p><strong>Backup Toner dan Drum</strong><br>Tersedia jika dibutuhkan, tanpa biaya tambahan.</p>
                            </div>
                            <div class="col-md-4 mb-4 px-3">
                                <img src="{{ asset('images/icons/6.png') }}" alt="Solusi Cerdas" class="why-icon mb-2">
                                <p><strong>Solusi Cerdas</strong><br>Hemat, fleksibel dan praktis untuk kebutuhan kantor modern.</p>
                            </div>
                        </div>
                        <p class="text-center mt-4">
                        Dengan kantor pusat di Jakarta, kami siap memberikan layanan cepat dan tepat waktu untuk setiap pelanggan.</br>
                           </br>
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide mb-4" data-aos="flip-up" data-aos-duration="800">
        <div class="artikel-card d-flex flex-column h-100 p-3 border rounded bg-white">
          ...
          <p class="flex-grow-1" style="text-align: center;">
